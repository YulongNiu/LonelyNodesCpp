...
\begin{equation*}
\begin{split}
s_{stop} &: \{ \Gamma(p_n) \cap X \}, \{r \in R, p_1, \dots, p_n \}, \{ \} \\
\end{split}
\end{equation*}
...
In `LOVO`, $x_n$ is chosen to maximize $|N(x_n)|$:
