...
`LOVO`, even the operation gs$\Gamma(p_1) \cap P$ in Bron-Kerbosch's algorithm, benefited greatly from `and` and `or` with hardware optimization in different languages.
